...
const services = [
    ...
    },
    {
      ...
      description: 'Supply, installation and service of Refrigeration Systems such as Air conditioners, Cold rooms and more',
    ...
    },
    {
      ...
      description: 'Supply of computers and accessories, installation anjd upgrading software',
    ...
    {
      name: 'CCTV Systems',
      description: 'Supply and Installation of Closed circuit television (CCTV) systems',
    ...
    {
      name: 'Solar Systems',
      description: 'Supply and Istallation of Solar Systems and Solar Irrigation Systems',
    ...
    },
    {
      ...
      description: 'Supply, install, train and support of Sage Premier Payroll and HR software',
    ...
    },
    {
      ...
      description: 'Supply, install, train and support QuickBooks accounting package and Sage 50 Accounting package',
    ...
    },
    {
      ...
      description: 'Supply, Install, train and support of different antivirus software \nSupply, server and client server security solutions',
      icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 0c4.6 0 9.2 1 13.4 2.9L457.7 82.8c22 9.3 38.4 31 38.3 57.2c-.5 99.2-41.3 280.7-213.6 363.2c-16.7 8-36.1 8-52.8 0C57.3 420.7 16.5 239.2 16 140c-.1-26.2 16.3-47.9 38.3-57.2L242.7 2.9C246.8 1 251.4 0 256 0z"/></svg>',
    },
    {
      name: 'Mobile Mappers',
...
const Services = () => {
    return (
        <div className="py-12 mx-10 my-10" id="services">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl dark:text-white font-bold mb-2">What we offer</h2>
                    <p className="">
                        The following are some of the products and service provided at Yosa Limited.
                    </p>
                </div>
